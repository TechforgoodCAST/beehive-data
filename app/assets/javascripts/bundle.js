...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_React$Component) {
	    ...
	    function Main(props) {
	        ...
	        _this.state = { grantsList: [] };
	        return _this;
	    }
	
	    _createClass(Main, [{
	        key: 'addGrant',
	        value: function addGrant(grantToAdd) {
	            var newGrantsList = this.state.grantsList;
	        ...
	        value: function render() {
	            return React.createElement(
	                'div',
	                { className: 'container' },
	                React.createElement(_NewGrant2.default, { submitGrant: this.addGrant.bind(this) }),
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      props.grants.map(function (grant) {
	        return _react2.default.createElement(_Grant2.default, _extends({ key: grant.grantIdentifier }, grant));
	      })
	    )
	  );
	};
	...
	var Grant = function Grant(props) {
	  return React.createElement(
	    ...
	    React.createElement(
	      "span",
	      { className: "title" },
	      props.grantIdentifier
	    ),
	    React.createElement(
	      "p",
	      null,
	      "Funder: ",
	      props.funderIdentifier
	    ),
	    React.createElement(
	      "p",
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(/*! ./ReactInstrumentation */ 21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDebugTool = __webpack_require__(/*! ./ReactDebugTool */ 22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapObject = __webpack_require__(/*! fbjs/lib/mapObject */ 32);
